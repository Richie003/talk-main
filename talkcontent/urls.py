...
from .views import (
    ...
    EventDetailAPIView, RetrieveUserEventsView,
    EventUpdateAPIView, EventDeleteAPIView,
    CreatePostContentView, ListPostContentView,
    RetrieveDetailedPostContent, RetrieveUsersPostContentView, DeletePostContentView,
...
events_urlpatterns = [
    ...
    path('retrieve/<str:user_id>/', RetrieveUserEventsView.as_view(), name='user-events'),
    path('retrieve/<uuid:id>/', EventDetailAPIView.as_view(), name='event-detail'),
...
post_urlpatterns = [
    ...
    path('retrieve/', ListPostContentView.as_view()),
    path('retrieve/<str:pk>/', RetrieveDetailedPostContent.as_view()),
    path('retrieve/user/<str:pk>/', RetrieveUsersPostContentView.as_view()),
...
post_comments_urlpatterns = [
    ...
    path('update-comment/<str:id>/', UpdateCommentView.as_view()),
    path('delete-comment/<str:id>/', DeleteCommentView.as_view()),
]
urlpatterns = [
