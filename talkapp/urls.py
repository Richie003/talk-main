...
from .views import (
    ...
    # UserRoleMetricsView,
    GoogleLoginAPIView,
    ConcealUserInfoAPIView,
    DeleteAccountAPIView,
    SaveUserProfileView,
    RetrieveSavedUsersProfileViewSet,
)
...
save_user_profile_urlpatterns = [
    path("save-user-profile/", SaveUserProfileView.as_view()),
    path("retrieve-saved-users-profiles/", RetrieveSavedUsersProfileViewSet.as_view()),
]
account_urlpatterns = [
    ...
    path("hide-my-info/", ConcealUserInfoAPIView.as_view()),
...
urlpatterns = [
    ...
    path("profile/", include(save_user_profile_urlpatterns)),
